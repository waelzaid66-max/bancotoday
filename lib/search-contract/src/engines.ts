 ...
 *
 * We intentionally model ONLY filters backed by real data. Rent/sale are real
 * offer_type values. Car "import" maps to origin_type=imported (same industrial
 * origin axis). Do not invent engines with no API param.
 *
